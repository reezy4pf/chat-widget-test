...
(function() {
    ...
    const styles = `
        ...
        .n8n-chat-widget .chat-input button {
            ...
            font-family: inherit;
            font-weight: 500;
            height: 40px; /* Match height with textarea */
    ...
    // Add auto-resizing for textarea
    textarea.addEventListener('input', function() {
        this.style.height = '40px'; // Reset height to recalculate
        const newHeight = Math.min(100, Math.max(40, this.scrollHeight)); // Between 40px and 100px
    ...
    sendButton.addEventListener('click', () => {
        ...
        if (message) {
            sendMessage(message);
            textarea.value = '';
            textarea.style.height = '40px'; // Reset height after sending
        }
    });
